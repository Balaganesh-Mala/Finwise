...
const StudentSubmissions = () => {
    ...
    useEffect(() => {
        axios.get(`${API_URL}/api/trainer/courses`, authHeaders)
    ...
    useEffect(() => {
        ...
        axios.get(`${API_URL}/api/trainer/modules/${selectedCourse}`, authHeaders)
        ...
        <div className="space-y-6">
            ...
            {!loading && fetched && (
                <div className="space-y-5">
                    ...
                    {/* Tab Content */}
                    {activeTab === 'mcq' && <MCQTable rows={filteredMCQ} />}
                    {activeTab === 'tasks' && <TaskTable rows={filteredTasks} />}
                    {activeTab === 'assignments' && <AssignmentTable rows={filteredAssignments} />}
                </div>
            )}
        </div>
    );
